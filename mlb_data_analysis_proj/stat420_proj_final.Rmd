...
```{r}
plot(R_sq ~ Year, data = pctSalary_TimeAnalysis, xlab = "Year", ylab = "R-Squared", main = "R-Squared values for SLR of Win Percentage and Team Payroll Percentage", pch  = 20, cex  = 2, col  = "blue")
...
- The portion of Influential observations
...
- The portion of High leverage observations
```{r}
